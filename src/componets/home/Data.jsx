...
const Data = () => {
  return (
    <div className="home_data">
      ...
      <h3 className="home_subtitle">Junior Developer</h3>
      <p className="home_desc">
        I'm a fresh Information Technology graduate based in Lapu-Lapu City,
        Cebu, passionate about learning and applying my skills in real-world
        settings. Let's work together and create something amazing!
      </p>
    </div>
  );
};
